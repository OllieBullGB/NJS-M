...
void SNRLoggingApp::recordAndSaveMetricsAtTimestep()
{
    ...
    saveResultsToFile(jle, accuracy, ttfd, "/home/veins/workspace.omnetpp/InetWirelessTutorial/simulations/NJS_ap/results/snrResults.txt");
}

void SNRLoggingApp::saveResultsToFile(double jle, std::array<int, 4> accuracy, double ttfd, const std::string& filename)
{
