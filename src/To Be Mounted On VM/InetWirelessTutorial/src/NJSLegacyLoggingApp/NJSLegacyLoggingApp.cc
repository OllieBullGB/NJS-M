...
void NJSLegacyLoggingApp::recordAndSaveMetricsAtTimestep()
{
    ...
    saveResultsToFile(jle, accuracy, ttfd, speed, "/home/veins/workspace.omnetpp/InetWirelessTutorial/simulations/NJS_ap/results/legacyResults.txt");
}

void NJSLegacyLoggingApp::saveResultsToFile(double jle, std::array<int, 4> accuracy, double ttfd, double speed, const std::string& filename)
{
